...
static void setup_test_binding(struct mctp_binding *test_binding, struct mctp *test_endpoint, void *callback_ctx)
{
...
static void send_transport_control_message(void)
{
    ...
    rcv_ctrl_msg(&binding, (void *) &send_control_message_payload, sizeof(send_control_message_payload));
